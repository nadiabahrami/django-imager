...
from .views import LibraryView, AlbumView, PhotoView, add_photo, add_album
...
urlpatterns = [
    ...
    url(r'^albums/(?P<pk>[0-9]+)/edit/', login_required(add_album), name='create_al_view'),
    url(r'^photos/(?P<pk>[0-9]+)/edit/', login_required(add_photo), name='add_pho_view'),
]
